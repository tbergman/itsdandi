  ...
  return (
    <div className="Form">
      <InputWrapper
        ...
        field={firstName}
        send={send}
        sendType={"EDIT_FIRSTNAME"}
        placeholder="First Name*"
      />
      <InputWrapper
        field={lastName}
        send={send}
        sendType={"EDIT_LASTNAME"}
      ...
      >
        ...
        >
          <path
            d="M6.49216 9.48828L0.00370867 0.48828L12.9806 0.488281L6.49216 9.48828Z"
            fill="#C4C4C4"
          />
        </svg>
        ...
        <select
          ...
          onChange={(e) =>
            send({ type: "EDIT_EMPLOYEES", value: e.target.value })
          }
          ...
          sx={{
            color:
              employees.value !== ""
                ? "white !important"
                : "rgba(242, 242, 242, 0.24) !important",
          }}
        >
          ...
          <option value="10000-24999">10,000 to 24,999 people</option>
          <option value="25000-49999">25,000 to 49,999 people</option>
