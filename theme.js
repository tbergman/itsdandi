    ...
    values: {
      ...
      deijourney: {
        topgraphic: {
          position: "absolute",
          zIndex: 99,
          right: [(t) => `calc(calc(${t.colWidthDesktop}) + 80px)`],
          width: ["200px"],
          height: ["200px"],
          top: ["-100px"],
          div: {
        ...
        textmodules: {
          ...
          ".wrapper": {
            ...
            ".module": {
              ...
              ".section1": {
                width: [(t) => `calc(calc(${t.colWidthDesktop} * 5) + 160px)`],
      ...
      subnavigation: {
        ...
        ".link": {
          ml: ["53%", (t) => `calc(calc(${t.colWidthDesktop} * 2) + 120px)`],
          textDecoration: "none",
          height: ["100%", "auto"],
          display: "flex",
      ...
      header: {
        ...
        ".graphic": {
          ...
          ".box2": {
            ...
            bg: "#335AFF",
            bottom: 0,
            left: [(t) => t.colWidthDesktop],
            width: [(t) => `calc(calc(${t.colWidthDesktop} * 4) + 200px)`],
            height: "73%",
          },
          ".box3": {
            position: "absolute",
            ...
            height: "40%",
            width: [(t) => `calc(calc(${t.colWidthDesktop} * 2) + 120px)`],
            left: [(t) => `calc(calc(${t.colWidthDesktop} * 2) + 40px)`],
            bg: "#0227C4",
          },
          // div: {
          //   width: "100%",
      ...
      betterinsights: {
        ...
        ".table": {
          ...
          ".head": {
            ...
            display: "grid",
            gridAutoRows: ["200px"],
            gridTemplateColumns: ["4fr 1fr fr 1fr", "4fr 1fr 2fr 1fr"],
            ".headItem": {
              display: "flex",
              justifyContent: "center",
              alignItems: "flex-end",
